...
exports.additionalOptions = exports.plans = exports.protectionDetails = exports.locations = exports.articles = exports.partners = exports.faqs = exports.categories = exports.socialMedia = exports.contactInfo = exports.services = exports.quickLinks = exports.testimonials = exports.features = exports.deals = exports.navLinks = exports.carsData = void 0;
...
exports.carsData = [
    ...
    {
        id: 'volvo-xc90',
        image: "https://res.cloudinary.com/dlvjzaadt/image/upload/v1739630890/volvo_rg61wg.png",
        title: 'Volvo XC90',
...
exports.features = [
    {
        id: 1,
        icon: fa_1.FaShieldAlt, // Icon for security and reliability
        title: "Premium Fleet",
    ...
    {
        id: 2,
        icon: fa_1.FaHandsHelping, // Icon for customer service
    ...
    {
        id: 3,
        icon: fa_1.FaRocket, // Icon for speed and efficiency
    ...
    {
        id: 4,
        icon: gi_1.GiProgression, // Icon for innovation and convenience
...
exports.socialMedia = [
    { icon: fa_1.FaFacebook, href: '/' },
    { icon: fa_1.FaTwitter, href: '/' },
    { icon: fa_1.FaInstagram, href: '/' },
    { icon: fa_1.FaLinkedin, href: '/' },
];
exports.categories = [
    {
        id: 1,
        image: assets_1.luxury,
        title: 'Luxury Cars',
...
exports.partners = [
    { id: 1, logo: assets_1.allianz },
    { id: 2, logo: assets_1.blackrock },
    { id: 3, logo: assets_1.closebrothers },
    { id: 4, logo: assets_1.rac },
];
exports.articles = [
    {
        id: "uk-driving-laws",
...
exports.additionalOptions = [
    { id: 1, name: 'Additional Driver', price: 10, type: 'per day', icon: fa_1.FaUserPlus, details: 'Allows an extra driver to operate the rental vehicle.' },
    { id: 2, name: 'Prepaid Fuel', price: 50, type: 'one-time', icon: fa_1.FaGasPump, details: 'Get a full tank of fuel in advance and return the car empty.' },
    { id: 3, name: 'Island / Ferryboat Travel', price: 15, type: 'per day', icon: fa_1.FaShip, details: 'Covers additional insurance for ferry or island travel.' },
    { id: 4, name: 'Interior Protection', price: 5, type: 'per day', icon: fa_1.FaShieldAlt, details: 'Covers accidental spills or damage to the car interior.' },
    { id: 5, name: 'Snow Chains', price: 8, type: 'per day', icon: fa_1.FaSnowflake, details: 'Essential for driving in snowy or icy conditions.' },
    { id: 6, name: 'Navigation System', price: 7, type: 'per day', icon: fa_1.FaMapMarkedAlt, details: 'A GPS system to help navigate during the rental period.' },
    { id: 7, name: 'Baby Car Seat', price: 12, type: 'per day', icon: fa_1.FaBabyCarriage, details: 'Ensures child safety during travel.' },
    { id: 8, name: 'Roof Rack', price: 20, type: 'per day', icon: fa_1.FaCarBattery, details: 'Additional space for luggage or sports equipment.' },
];
